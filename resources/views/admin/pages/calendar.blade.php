              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div id="external-events">
                    ...
                    <div class="external-event bg-warning">Пойти домой</div>
                    <div class="external-event bg-info">Делать домашнюю работу</div>
                    <div class="external-event bg-primary">Работа над дизайном пользовательского интерфейса</div>
                    <div class="external-event bg-danger">Спать крепко</div>
                    <div class="checkbox">
